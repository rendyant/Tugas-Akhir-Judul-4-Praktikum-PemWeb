            ...
            <form method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           required 
                           minlength="3"
                           class="w-full px-4 py-3 bg-white/50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-yellow-300 transition-all">
                </div>
                ...
                <div>
                    ...
                    <textarea name="notes" 
                              rows="3"
                              class="w-full px-4 py-3 bg-white/50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-yellow-300 transition-all resize-none"><?= e($notes) ?></textarea>
                </div>

                <div class="flex gap-3 pt-2">
                    <button type="submit" 
                            class="flex-1 bg-yellow-200 hover:bg-yellow-300 text-yellow-800 font-semibold py-3 rounded-full transition-colors">
                        Perbarui
                    </button>
                    <a href="index.php" 
